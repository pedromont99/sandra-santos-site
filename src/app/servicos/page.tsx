          ...
          {pilares.map((pilar, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-1/2 space-y-8">
                ...
                <p className="text-lg text-[#F2EDE4]/70 leading-relaxed font-medium">
                  {pilar.description}
                </p>
                ...
                <button className="flex items-center gap-2 text-[#8C6D3F] font-bold uppercase text-xs tracking-widest pt-6 border-b border-[#8C6D3F]/20 pb-2 hover:border-[#8C6D3F] transition-all group">
                  Saber mais detalhes 
