      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div className="space-y-8">
            <p className="text-[#8C6D3F] text-xs font-bold uppercase tracking-[0.3em]">
              O Rosto por trás da marca
            </p>
            <h1 className="text-4xl md:text-6xl font-bold text-[#F2EDE4] leading-tight">
              Estratégia com alma, <br />
              <span className="text-[#8C6D3F] italic font-serif">comunicação com propósito.</span>
            </h1>
            <div className="space-y-6 text-lg text-[#F2EDE4]/80 leading-relaxed">
              <p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-32">
          {[
            ...
            <div
              key={item.id}
              className="p-10 border border-[#F2EDE4]/10 bg-[#1C1C1E] rounded-[2rem] group hover:bg-[#F2EDE4] transition-all duration-700 shadow-sm hover:shadow-2xl"
            >
              {/* O Número agora salta à vista */}
              <span className="block text-[#8C6D3F] font-serif italic text-3xl mb-4 group-hover:text-[#1C1C1E]/50 transition-colors">
                {item.id}.
              </span>

              {/* Título com mais peso e impacto */}
              <h3 className="text-[#F2EDE4] font-black text-xl uppercase tracking-tighter mb-4 group-hover:text-[#1C1C1E] transition-colors">
                {item.title}
              </h3>

              {/* Corpo do texto mais refinado */}
              <p className="text-[#F2EDE4]/70 text-base md:text-lg leading-relaxed group-hover:text-[#1C1C1E]/80 transition-colors font-medium">
                {item.desc}
              </p>
            </div>
          ))}
        ...
        <section className="bg-[#F2EDE4] rounded-[3rem] p-8 md:p-24 text-[#1C1C1E] mb-32 relative overflow-hidden shadow-[0_20px_50px_rgba(56,38,34,0.3)]">

          {/* Luz de fundo para dar profundidade e não deixar o castanho "morrer" */}
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#8C6D3F]/10 blur-[120px] rounded-full -mr-32 -mt-32" />

          <div className="max-w-4xl relative z-10">
            <p className="text-[#C8A96E] font-bold text-xs uppercase tracking-[0.4em] mb-12 drop-shadow-sm">
              Metodologia
            </p>
            ...
            <h2 className="text-4xl md:text-6xl font-bold mb-16 leading-[1.1] tracking-tighter">
              ...
              <span className="text-[#C8A96E] italic font-serif drop-shadow-[0_2px_10px_rgba(212,163,115,0.2)]">
