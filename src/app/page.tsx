  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[800px] bg-gradient-to-tr from-[#F8F5F2] via-[#E8E2DC] to-[#D8D2CC] opacity-30 blur-[120px] -z-10" />

        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
          
          {/* COLUNA DA IMAGEM: Agora visível em Mobile (topo) e Desktop (direita) */}
          <div className="relative order-first lg:order-last w-full max-w-[400px] lg:max-w-[500px] mx-auto lg:justify-self-end">
            
            {/* Elemento de Performance - Oculto em ecrãs muito pequenos para não poluir */}
            ...
            <div className="relative w-full aspect-[4/5] rounded-[2rem] overflow-hidden border border-[#382622]/10 shadow-2xl lg:rotate-1 hover:rotate-0 transition-transform duration-700">
              <Image 
                ...
                priority
              />
              {/* Overlay suave para integrar a foto no fundo creme */}
